...
class Accounts_model extends CI_Model
{
    ...
    {
        return $this->db->count_all('general_ledger');
    }
    ...
    {
        $row = $this->db
            ->select('COUNT(DISTINCT voucher_code) AS total')
    ...
    --------------------------------------------------------------*/
    public function get_journal_count()
    {
        $row = $this->db
            ->select('COUNT(DISTINCT voucher_code) AS total')
    ...
    /*--------------------------------------------------------------
    | Total Contra Entries
    --------------------------------------------------------------*/
    public function get_contra_count()
    {
        $row = $this->db
            ->select('COUNT(DISTINCT voucher_code) AS total')
            ->where('voucher_type', 'N')
            ->where('cancel', 0)
            ->get('voucher_transaction')
            ->row();
    ...
    | Total Debit Notes
    --------------------------------------------------------------*/
    public function get_debit_note_count()
    {
        $row = $this->db
            ->select('COUNT(DISTINCT voucher_code) AS total')
            ->where('voucher_type', 'D')
            ->where('cancel', 0)
            ->get('voucher_transaction')
            ->row();
    ...
    {
        $row = $this->db
            ->select('COUNT(DISTINCT voucher_code) total')
            ->where('voucher_type','R')
            ->where('cancel',0)
            ->where('DATE(voucher_date)=CURDATE()',NULL,FALSE)
            ->get('voucher_transaction')
            ->row();
    ...
    | Today's Payments
    --------------------------------------------------------------*/
    public function today_payments()
    {
        $row = $this->db
            ->select('COUNT(DISTINCT voucher_code) total')
            ->where('voucher_type','P')
    ...
    | Today's Journals
    --------------------------------------------------------------*/
    public function today_journals()
    {
        $row = $this->db
            ->select('COUNT(DISTINCT voucher_code) total')
            ->where('voucher_type','J')
    ...
    | Cash In
    --------------------------------------------------------------*/
    public function get_today_cash_in()
    {
        $row = $this->db
    ...
    | Cash Out
    --------------------------------------------------------------*/
    public function get_today_cash_out()
    {
        $row = $this->db
            ->select('SUM(amount) total')
            ->where_in('voucher_type',array('P','EX'))
            ->where('cancel',0)
            ->where('DATE(voucher_date)=CURDATE()',NULL,FALSE)
            ->get('voucher_transaction')
            ->row();
    ...
    | Net Cash
    --------------------------------------------------------------*/
    public function get_today_net_cash()
    {
        return $this->get_today_cash_in() - $this->get_today_cash_out();
    }

    /*--------------------------------------------------------------
    | Recent Receipts
    --------------------------------------------------------------*/
    public function get_recent_receipts($limit = 5)
    {
        return $this->db
            ->select('
                vt.voucher_code,
            ...
            ->join('customer_master cm', 'cm.customer_id = vt.customer_id', 'left')
    ...
    | Recent Journals
    --------------------------------------------------------------*/
    public function get_recent_journals($limit = 5)
    {
        return $this->db
            ->select('voucher_code,
                    voucher_date,
    ...
    | Month Transactions
    --------------------------------------------------------------*/
    public function get_month_transactions()
    {
        $row = $this->db
            ->select('COUNT(DISTINCT voucher_code) total')
    ...
    --------------------------------------------------------------*/
    public function get_recent_bank_reconciliation($limit = 5)
    {
        return $this->db
            ->select('
                reconciliation_id,
