...
<div class="right_col " role="main">
    <div class="col-md-12 col-sm-12 ">
        <div class="page-title">
			...
			<div class="title_right">
				<div class="col-md-5 col-sm-4  form-group pull-right">
				<div class="btn-group">
	...
	$except = array('Project/project_dashboard','Project/list_resource_planning','Project/edit_resource_planning','Project/add_resource_planning');
    ?>
