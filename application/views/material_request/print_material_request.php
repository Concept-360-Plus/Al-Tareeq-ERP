...
<button type="button"
   ...
   <h2 class="title">
    Material Request  - <?php echo htmlspecialchars($mInfo->material_request_no); ?>
</h2>
                ...
                <?php if (!empty($item->materials)): ?>
                    ...
                    <?php foreach (
                        ...
                        <tr>
                            ...
                            <td>
                                <?= (int)$material->required_quantity ?>
                            </td>
                            <td>
                                <?= (int)$material->previously_requested ?>
                            </td>
                            <td>
                                <?= (int)$material->remaining_quantity ?>
                            </td>
                            <td>
                                <?= htmlspecialchars(
                                    $material->unit ?? ''
    ...
    <?php endif; ?>
    <?php if (!empty($job_order->premarks)): ?>

        <u><h6 style="margin-top:10px;">Project</h4></u>
    ...
    <?php endif; ?>
     <?php if (!empty($mInfo->material_request_no)): ?>

        <u><h6 style="margin-top:10px;">Material Request</h4></u>
        
        <div class="remarks-box">

            <?= nl2br(
                htmlspecialchars($mInfo->remarks)
            ) ?>
