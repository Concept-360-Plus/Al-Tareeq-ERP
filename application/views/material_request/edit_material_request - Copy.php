        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="project-info-item">
                    ...
                    <div id="project_name" class="project-info-value"><?= $mr['project_name'] ?></div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="project-info-item">
                    ...
                    <div id="customer_name" class="project-info-value"><?= $mr['customer_name'] ?></div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="project-info-item">
                    <label>Branch</label>
                    <div id="branch_name" class="project-info-value"><?= $mr['branch_name'] ?></div>
                </div>
            </div>
            ...
            <td>
                       <select name="unit[]"  tabindex='2' class="form-control" >
                                ...
                                <?php foreach ($units as $ut): ?>
                                    <option value="<?= $ut['unit_id'] ?>" <?= ($r['item_unit']==$ut['unit_id'])?'selected':''; ?>
                                        >
...
foreach ($units as $itm) {
    //$id = $itm['product_id'];
    //$name = $itm['product_name'];
   $unitOptions .= '<option value="' . $itm['unit_id'] . '">'
...
$(document).ready(function(){
    ...
    $("#add_row").click(function () {
        ...
        html += "<td>";
        html += "<select name='unit[]' class='form-control' tabindex='2'>";
        html += unitOptions;
        html += "</select>";
        html += "</td>";
