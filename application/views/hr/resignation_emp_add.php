...
<div class="x_panel">
        ...
        <form id="main"
                ...
                <div class="col-md-5">
                    <div class="input-group date datepicker1">
                        ...
                        <div class="input-group date">
                            <input type="date" class="form-control form-control-sm" id="resignation_date" name="resignation_date" value="<?php echo date('Y-m-d'); ?>" tabindex="2" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="input-group date">
                        <input type="date" class="form-control form-control-sm" id="last_working_date" name="last_working_date" value="<?php echo date('Y-m-d'); ?>" tabindex="2" required>
                        <div class="input-group-addon"></div>
                    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-5">
            <input type="text" class="form-control form-control-sm" id="notice_days" name="notice_days" min="0" step="1" required>
        </div>
    </div>
                ...
                <tbody>
                    <tr id="addr0">
                        ...
                        <td class="text-center">
                            <a id="add_row" title="Add" class="btn btn-sm btn-success"><span class="fa fa-plus"></span></a>
                            <a id="delete_row" title="Delete" class="btn btn-sm btn-danger"><span class="fa fa-trash"></span></a>
                        </td>
                    </tr>
                    <tr id="addr1"></tr>
                </tbody>
