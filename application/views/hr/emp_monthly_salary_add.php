    ...
    <div class="x_content">
        ...
        <?php if (!empty($employee_salary_data)) { ?>
            ...
            <form method="post" action="<?php echo base_url('index.php/Hr/add_monthly_salary_data'); ?>">
                <input type="hidden" name="effective_date" value="<?php echo htmlspecialchars($effective_date); ?>">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($employee_salary_data as $row) { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= number_format($row->working_days, 0) ?>
                                    </td>
                                    ...
                                    <td>
                                        <?= number_format($row->payable_days, 2) ?>
                                    </td>
