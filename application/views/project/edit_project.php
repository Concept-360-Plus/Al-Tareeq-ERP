<style>
    ...
    #project_items_table{width:95%;}
    #bordered td, #bordered th{border:none !important;}
</style>
...
<table id="bordered"class="table table-bordered" style="width:95%;border:none">
<tr>
...
<tr>
    ...
    <td colspan="1">
        <input type="text" name="subject" id="subject" class="form-control"
               value="<?= $project['subject'] ?>" readonly>
    </td>
</tr>
...
<h5>Project Items</h5>
<table class="table table-bordered col-md-12" id="project_items_table">
<thead>
<tr>
    <th>#</th>
    <th>Item</th>
