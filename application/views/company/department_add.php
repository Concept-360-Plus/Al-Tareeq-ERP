<div class="card-body">
	<form id="main" method="post" action="<?php echo base_url() . 'index.php/'; ?>Hr/save_department" id="addform" autocomplete="off">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<select
					...
					<?php foreach ($dashboard_list as $dashboard) { ?>
