        ...
        <div class="well" style="overflow: auto">
          <div class="col-md-12">
            ...
            <div class="col-md-3 text-nowrap">
              ...
              <a href="javascript:void(0);" class="btn btn-warning" onclick="printPOReport(event)" style="color:#000;">
                <i class="fa fa-print"></i> Print
              </a>

              <a href="javascript:void(0);" class="btn btn-success" onclick="exportPOExcel(event)">
...
<script>
  ...
  function exportPOExcel(event) {
    ...
    const baseUrl =
      "<?= base_url('index.php/Reports/export_po_excel'); ?>";
